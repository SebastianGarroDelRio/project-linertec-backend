...
<div class="container" style="margin-top: 1%">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #0063AE;">
                <h4 class="panel-title">
                    <a  data-parent="#accordion" href="#collapseAll" style="color: white;">PRODUCTO</a>
                </h4>
            </div>
			...
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-content">
					<div class="modal-header" style="padding: 35px 50px">
						...
						<h4>
							<span class="glyphicon glyphicon-ok-sign"></span> REGISTRO DE PRODUCTO
						</h4>
					</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_descripcion"
														name="descripcionProducto" placeholder="Ingrese la descripcion"
														type="text" />
												</div>
											</div>
			...
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-content">
					<div class="modal-header" style="padding: 35px 50px">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4>
							<span class="glyphicon glyphicon-ok-sign"></span> ACTUALIZAR PRODUCTO
						</h4>
					</div>
					<div class="modal-body" style="padding: 20px 10px;">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_act_descripcion"
														name="descripcionProducto" placeholder="Ingrese la descripcion" type="text" />
												</div>
											</div>	
	...
	$.getJSON("listaCategoria", {}, function(data){
		$.each(data, function(i,item){
			$("#id_reg_categoria").append("<option value="+item.idCategoria +">"+ item.descripcionCategoria +"</option>");
			$("#id_act_categoria").append("<option value="+item.idCategoria +">"+ item.descripcionCategoria +"</option>");
		});
	});
	
	$.getJSON("listaProveedor", {}, function(data){
		$.each(data, function(i,item){
			$("#id_reg_proveedor").append("<option value="+item.idProveedor +">"+ item.nombreProveedor +"</option>");
			$("#id_act_proveedor").append("<option value="+item.idProveedor +">"+ item.nombreProveedor +"</option>");
		});
	});
		 ...
		 $('#id_table').DataTable({
				...
				columns:[
					...
					{data: function(row, type, val, meta){
						var salida='<button type="button" style="width: 90px" class="btn btn-info btn-sm" onclick="editar(\''+row.idProducto + '\',\'' + row.descripcionProducto + '\',\'' + row.proveedor.idProveedor + '\',\'' + row.categoria.idCategoria + '\')">Editar</button>';
						return salida;
					},className:'text-center'},	
					{data: function(row, type, val, meta){
					    var salida='<button type="button" style="width: 90px" class="btn btn-warning btn-sm" onclick="accionEliminar(\'' + row.idProducto + '\')">'+ (row.estado == 1? 'Activo':'Inactivo') +  '</button>';
						return salida;
					},className:'text-center'},													
				]                                     
		    }); 
	...
	function editar(idProducto,descripcionProducto,idproveedor,idcategoria){	
