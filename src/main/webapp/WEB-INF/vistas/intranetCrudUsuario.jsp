...
<div class="container" style="margin-top: 1%">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #0063AE;">
                <h4 class="panel-title">
                    <a  data-parent="#accordion" href="#collapseAll" style="color: white;">USUARIO</a>
                </h4>
            </div>
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_nombre">Usuario</label>
												<div class="col-lg-8">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_dni"
														name="dni" placeholder="Ingrese el dni" type="text" />
												</div>
											</div>
											<div class="form-group">
	...
	$("#id_txt_filtro").keyup(function(){
	    ...
	    $.getJSON("consultaCrudUsuario", {"filtro": fil}, function (lista){
	...
	$(document).ready(function(){
		...
		function editar(idUsuario, nombres, dni, login, password,
				correo, direccion, fechaNacimiento) {
			$('#id_ID').val(idUsuario);
