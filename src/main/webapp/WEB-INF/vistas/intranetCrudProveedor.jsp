...
<div class="container" style="margin-top: 1%">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #0063AE;">
                <h4 class="panel-title">
                    <a  data-parent="#accordion" href="#collapseAll" style="color: white;">PROVEEDOR</a>
                </h4>
            </div>
						...
						<table id="id_table" class="table table-striped table-bordered">
							<thead>
								<tr>
									...
									<th style="width: 10%">Telefono Contacto</th>
			...
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-content">
					<div class="modal-header" style="padding: 35px 50px">
						...
						<h4>
							<span class="glyphicon glyphicon-ok-sign"></span> REGISTRO DE PROVEEDOR
						</h4>
					</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_nombre"
														name="nombreProveedor" placeholder="Ingrese el nombre del proveedor" type="text" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_correo"
														name="correo" placeholder="Ingrese el nombre del proveedor" type="text" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_telefono"
														name="telefono" placeholder="Ingrese el nombre del proveedor" type="text" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_direccion"
														name="direccion" placeholder="Ingrese el nombre del proveedor" type="text" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_contacto"
														name="nombreContacto" placeholder="Ingrese el nombre del proveedor" type="text" />
												</div>
											</div>
											
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_telefono_contacto">Telefono contacto</label>
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_telefono_contacto"
														name="telefonoContacto" placeholder="Ingrese el nombre del proveedor" type="text" />
												</div>
											</div>
											
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_tipo_documento">Tipo Documento</label>
												<div class="col-lg-6">
													<select id="id_reg_tipo_documento" name="tipoDocumento" class='form-control'>
			...
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-content">
					<div class="modal-header" style="padding: 35px 50px">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4>
							<span class="glyphicon glyphicon-ok-sign"></span> ACTUALIZAR PROVEEDOR
						</h4>
					</div>
					<div class="modal-body" style="padding: 20px 10px;">
								...
								<div class="panel panel-default">
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_act_correo"
														name="correo" placeholder="Ingrese el nombre del proveedor" type="email" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_act_telefono"
														name="telefono" placeholder="Ingrese el nombre del proveedor" type="number" />
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_telefono_contacto">Telefono contacto</label>
												<div class="col-lg-8">
													<input class="form-control" id="id_act_telefono_contacto"
														name="telefonoContacto" placeholder="Ingrese el nombre del proveedor" type="number" />
												</div>
											</div>
											
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_act_tipo_documento">Tipo Documento</label>
												<div class="col-lg-6">
													<select id="id_act_tipo_documento" name="tipoDocumento" class='form-control'>
														<option value=" ">[Seleccione]</option>
													</select>
												</div>
											</div>
	...
	$.getJSON("listaTipoDocumento", {}, function(data){
		$.each(data, function(i,item){
			$("#id_reg_tipo_documento").append("<option value="+item.idTipoDocumento +">"+ item.nombreDocumento +"</option>");
			$("#id_act_tipo_documento").append("<option value="+item.idTipoDocumento +">"+ item.nombreDocumento +"</option>");
		});
	});	
		 ...
		 $('#id_table').DataTable({
				...
				columns:[
					...
					{data: function(row, type, val, meta){
						var salida='<button type="button" style="width: 90px" class="btn btn-info btn-sm" onclick="editar(\''+row.idProveedor + '\',\'' + row.nombreProveedor + '\',\'' + row.correo + '\',\'' + row.telefono + '\',\'' + row.direccion + '\',\'' + row.nombreContacto + '\',\'' + row.telefonoContacto + '\',\'' + row.tipoDocumento.idTipoDocumento + '\')">Editar</button>';
						return salida;
					},className:'text-center'},	
					{data: function(row, type, val, meta){
					    var salida='<button type="button" style="width: 90px" class="btn btn-warning btn-sm" onclick="accionEliminar(\'' + row.idProveedor + '\')">'+ (row.estado.idestado == 1? 'Activo':'Inactivo') +  '</button>';
						return salida;
					},className:'text-center'},													
				]                                     
		    }); 
	...
	function editar(idProveedor,nombreProveedor,correo,telefono,direccion,nombreContacto,telefonoContacto,idTipoDocumento,idestado){	
