	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-5 col-lg-5">
				<div class="ban_img">
					<figure>
						<img src="img/foto01.png" style="width: 400px; margin-bottom: 70px;" alt="#"/>
					</figure>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 col-lg-7">
				<div class="about_box">
					...
					<p>It is a long established fact that a reader will be
						...
						layout. The point of usingt</p>
					<span class="try">TRY ONLINE CV BUILDER FOR Free</span> <a
						class="read_morea" href="#">Empezar <i
			...
			<div class="col-md-12 col-lg-5">
				<div class="about_img">
					<figure>
						<img src="img/logolinertec.png" alt="#" />
					</figure>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-7">
				<div class="titlepage">
					<h2>
						<strong class="yellow">ALIADOS</strong><br>GRUPO LINERTEC
					</h2>
				</div>
			</div>
		</div>
...
<div class="portfolio">
	<div class="container">
		<div class="row">
			<div class="col-md-12 ">
				<div class="titlepage">
					<h2>
						<strong class="yellow">PROYECTOS</strong><br> CALIDAD Y EFICACIA <br> EN NUESTROS SERVICIOS
					</h2>
					<span>Websites</span>
					<p>It is a long established fact that a reader will be
						distracted by the readable content of a page when looking at its
	...
	<div id="myCarousel" class="carousel slide portfolio_Carousel "
		data-ride="carousel">
