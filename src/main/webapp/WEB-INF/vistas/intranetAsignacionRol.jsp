        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #0063AE;">
                <h4 class="panel-title">
                    <a  data-parent="#accordion" href="#collapseAll" style="color: white;">ROL</a>
                </h4>
            </div>
								...
								<div class="panel panel-default">
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_correo"
														name="correo" placeholder="Ingrese el correo" type="email" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_contacto">Nombre
													Contacto</label>
												<div class="col-lg-8">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_act_direccion"
														name="direccion" placeholder="Ingrese el DNI"
														type="text" />
												</div>
											</div>
											<div class="form-group">
